...
-- Seed Products with Premium Local Generated Images
...
-- Seed Users (Plaintext password matching user-service auth logic)
INSERT INTO users (email, name, password, role) VALUES
('admin@gmail.com', 'Admin User', 'admin123', 'ADMIN'),
('user@gmail.com', 'Regular User', 'user123', 'USER');
